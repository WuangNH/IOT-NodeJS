...
// });
 ...
 // lấy số đo được từ 3 số lên trên FE
  ...
  function getColorForValue(value) {
    // Định nghĩa màu nền dựa trên giá trị
    // Ví dụ: Màu đậm cho giá trị lớn hơn 50 và màu nhạt cho giá trị nhỏ hơn hoặc bằng 50
    if (value > 50) {
      return "#54006e"; // Màu đậm (ví dụ: đỏ)
    } else {
      return "#ecaeff"; // Màu nhạt (ví dụ: xanh)
    }
  }
